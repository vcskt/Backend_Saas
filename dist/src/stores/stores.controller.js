...
let StoresController = class StoresController {
    ...
    update(id, dto, req) {
        return this.storesService.update(id, dto, req.user.id, req.user.role === client_1.Role.ADMIN);
    }
    remove(id, req) {
        return this.storesService.remove(id, req.user.id, req.user.role === client_1.Role.ADMIN);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StoresController.prototype, "findMine", null);
__decorate([
